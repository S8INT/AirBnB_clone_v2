...
class TestDBStorage(unittest.TestCase):
    ...
    def test_new(self):
        """ Test if new object is correctly added to database """
        new = User(
    ...
    def test_delete(self):
        """ Tests if object is correctly deleted from database """
        new = User(
            email='john2020@gmail.com',
            password='password',
            first_name='John',
    ...
    def test_save(self):
        """ Tests if object is successfully saved to database """
        new = User(
            email='john2020@gmail.com',
            password='password',
            first_name='John',
